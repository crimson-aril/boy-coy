...
goog.addDependency = function(a, b, d) {
    if (!COMPILED) {
        var c;
        a = a.replace(/\\/g, "/");
        for (var e = goog.dependencies_, f = 0; c = b[f]; f++)
            e.nameToPath[c] = a,
...
!COMPILED && goog.ENABLE_DEBUG_LOADER && (goog.included_ = {},
goog.dependencies_ = {
    pathToNames: {},
    nameToPath: {},
    requires: {},
...
goog.writeScripts_ = function() {
    function a(e) {
        if (!(e in c.written)) {
            if (!(e in c.visited) && (c.visited[e] = !0,
            e in c.requires))
...
var boycoy = {
  ...
  , Hovers = function() {
    ...
    $(".ad .linkedin .over").css("opacity", 0);
...
(function() {
    for (var a = 0, b = ["ms", "moz", "webkit", "o"], d = 0; d < b.length && !window.requestAnimationFrame; ++d)
...
function EventsManager(a) {
    ...
    this.removeEventListener = function(d, c) {
        a && console.log('Removing event listener for "' + d + '".');
    ...
    this.dispatch = function(d) {
        ...
        if (b[d]) {
            ...
            console.error("Couldn't dispatch event. Type \"" + JSON.stringify(d) + '" doesn\'t exist. Please use "registerType" method first.')
    }
}
...
var Drawer = function() {
    ...
    this.updateOffset = function(a, b) {
        ...
        if (g) {
            ...
            console.error("Unknown object id " + a)
    }
    ;
...
var Parallaxer = function(a) {
    ...
    this.setTargetScrollPosition = function(a) {
        e !== a && (e = a,
        b.dispatch(ParallaxerEvent.TARGET_POSITION_CHANGED, new ParallaxerEvent(this)),
        d && k.start())
    }
    ;
    var h = Utils.delegate(this, function(a) {
        !1 === n(a, !1) && (k.stop(),
        b.dispatch(ParallaxerEvent.AFTER_LOOP_STOP, new ParallaxerEvent(this)))
    })
        ...
        if (0.2 < l || q) {
            if (!1 === d)
                for (var n in g) {
                    ...
                    "auto" !== x && (u += Number(x.replace(/px/, "")),
                    t.style[k.type == Parallaxer.HORIZONTAL ? "left" : "top"] = "0");
                    k.initialVisiblePosition = u;
                    m.addObject(k.id, t, k.type === Parallaxer.HORIZONTAL ? DrawerObject.HORIZONTAL : DrawerObject.VERTICAL, 0)
                }
            k = !0;
            f ? (h = h / 30 * (a / (1E3 / 60)),
            1 > Math.abs(h) && (h = 1 * (0 < h ? 1 : -1)),
            c += h,
            0 > l - Math.abs(h) && (c = e)) : c = e;
            b.dispatch(ParallaxerEvent.CURRENT_POSITION_CHANGED, new ParallaxerEvent(this));
            m.startFrame();
            var l = c, y;
            for (y in g)
                h = g[y],
                m.updateOffset(h.id, Math.floor(h.initialVisiblePosition + (h.scrollOffset - l) * h.speed));
            m.draw();
            !1 === d && (d = !0,
            b.dispatch(ParallaxerEvent.AFTER_FIRST_DRAW, new ParallaxerEvent(this)))
        }
        return k
    });
    l()
...
var ParallaxeLoader = function(a, b) {
    var d = null
      ...
      , m = Utils.delegate(this, function() {
        ...
        c.home.add(".page1 .layer.header", 1.65);
        ...
        c.about.add(".page3 .layer.background", 1);
        ...
        (new ParallaxerGroup(d,".page4",-0.03,ParallaxerGroup.HORIZONTAL)).add(".page4 .layer.background3 .wave", 1);
    ...
    var k = function() {
      ...
      , h = Utils.delegate(this, function(b) {
        ...
        b + d / c.apps.getReferenceSpeed() < this.getGroupScrollPosition("apps") ? a.saveLocation("home") : b + d / c.about.getReferenceSpeed() < this.getGroupScrollPosition("about") ? a.saveLocation("apps") : b + d / c.contact.getReferenceSpeed() < this.getGroupScrollPosition("contact") ? a.saveLocation("about") : a.saveLocation("contact")
    })
      , n = function() {
        var a = f.speed
    ...
    (function() {
        ...
        a.on("click mousemove", function(a) {
            for (var c = 0; c < b.length; c++) {
                ...
                n && l ? (g.trigger(a.type),
                !1 == d[c] && (d[c] = !0,
                g.trigger("mouseover"))) : !0 == d[c] && (d[c] = !1,
                g.trigger("mouseout"))
            }
        })
    }
...
var Mail = function() {
    ...
    var q = function(a) {
      ...
      , t = function(a, b) {
        "true" !== a.data("isErrorSet") && (a.data("isErrorSet", "true"),
        console.log(b),
        a.find(".underline").delay(b).animate({
            backgroundColor: "#ff0000"
        }, 400),
        a.find(".exclamationMark").delay(b).fadeIn(400))
    }
      , u = function(a) {
        "true" === a.data("isErrorSet") && (a.data("isErrorSet", "false"),
        a.find(".underline").animate({
            backgroundColor: f
        }, 400),
        a.find(".exclamationMark").fadeOut(400))
    };
    (function() {
        new Envelope;
        ...
        a.click(function() {
            ...
            if (0 < a.length && 0 < b.length && 0 < c.length)
                ...
                var e = 0;
                !(0 < a.length) && "true" !== m.data("isErrorSet") && (t(m, 400 * e),
                e++);
                !(0 < b.length) && "true" !== k.data("isErrorSet") && (t(k, 400 * e),
                e++);
                !(0 < c.length) && "true" !== l.data("isErrorSet") && (t(l, 400 * e),
                e++)
            }
            !0 === d && s(function() {
...
var MailFieldExpander = function(a) {
    ...
    var n = function(a) {
      ...
      , p = function() {
        var d = Math.round(h.height() / 27)
          , g = k;
        0 !== d - k && (g = 6 < d ? 6 : 2 > d ? 2 : d);
        d = g - k;
        if (0 !== d) {
            k = g;
            for (g = 0; g < Math.abs(d); g++)
                0 < d ? q() : (e.find(".underline").last().remove(),
                e.find("br").last().remove(),
                m = e.find(".underline").last(),
...
var LocationHandler = function() {
    ...
    this.saveLocation = function(a) {
        ...
        d[1] !== a && (b = !1,
        d[1] = a,
        $(window).off("hashchange", c),
        window.location.href = d.join("#"),
        $(window).on("hashchange", c))
    }
    ;
    var c = function() {
    ...
    var c = null
      ...
      , l = function(b, c, d) {
        ...
        for (var e = 0; e < a.length; e++)
            a[e] != b && a[e] != c && $(a[e].slide).css("z-index", 0);
        $(c.slide).fadeIn(d, function() {});
        null !== b && ($(b.indicatorOn).fadeOut(d),
        $(b.indicatorOff).fadeIn(d),
        $(b.activeArea).addClass("inactive"),
        $(b.activeArea).removeClass("active"));
...
var DragAndDrop = {
    ...
    init: function() {
        ...
        window.addEventListener("keypress", Utils.delegate(this, function(a) {
            ...
            if (48 <= a.keyCode && 57 >= a.keyCode)
                null !== this.activeElement && document.getElementById("layer" + (a.keyCode - 48)).getElementsByClassName("page1")[0].appendChild(this.activeElement);
            else if (122 === a.keyCode) {
                var b = this.history.pop();
                b && (console.log(b.name),
                $(b.name).each(function(a, c) {
                    c.style.left = b.left;
                    c.style.top = b.top;
...
var Rotator = function(a, b) {
    ...
    var m = function() {
      ...
      , k = function() {
        0.02 < f ? (f -= 0.02,
        e += 0.05,
        a.style[Modernizr.prefixed("transform")] = "rotate(" + f * Math.sin(e) + "deg)") : (e = f = 0,
...
var Dev = function() {
    this.checkAndInit = function() {
        ...
        $("body").css(Modernizr.prefixed("user-select"), "none"),
        DragAndDrop.init(),
        CssGenerator.init(),
        $(".devTools").show(),
        $(".devTools .testSpeedAll").click(function() {
            console.debug("Will start in 2 seconds...");
            $(".devTools").hide();
            scrollParallaxer.startTest(function(a, b) {
                $(".devTools").show();
...
var Main = function() {
    var a = null
      ...
      , h = function() {
        w();
        e ? ($("html").addClass("no-parallaxe"),
        $(".page1").attr("id", "home"),
        $(".page2").attr("id", "apps"),
        $(".page3").attr("id", "about"),
        $(".page4").attr("id", "contact")) : $("html").addClass("parallaxe");
        if (!1 == e) {
            var a = $(".page0 img");
            g = a.length;
            a.each(function(a, b) {
      ...
      , q = function() {
        ...
        !1 === e ? (a = new LocationHandler,
        d = new ParallaxeLoader(a,b),
        c = d.getParallaxer(),
        a.addEventListener(a.LOCATION_CHANGED, function(a) {
            a = d.getGroupScrollPosition(a.name);
            $(document).scrollTop(a)
        }),
        Modernizr.csstransforms && new Ufo,
        c.addEventListener(ParallaxerEvent.AFTER_FIRST_DRAW, s),
        d.init()) : v()
    }
      , s = function() {
        c.removeEventListener(ParallaxerEvent.AFTER_FIRST_DRAW, v);
        v()
    }
      , v = function() {
        !1 === e && $(".page0").hide();
      ...
      , r = function() {
        ...
        Dev.checkAndInit();
        !1 === e && (b = a.getLocation(),
        0 === window.pageYOffset && (b ? (b = d.getGroupScrollPosition(b),
        $(document).scrollTop(b)) : $(document).scrollTop(d.getGroupScrollPosition("home"))));
        t()
    }
      , w = function() {
        var a = null;
      ...
      , u = function() {
        ...
        d.start(),
        $("#awwwards").delay(3500).fadeIn(1500))
    };
    Utils.delegate(this, function() {
        $(window).ready(h);
        $(window).load(n)
